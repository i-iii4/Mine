# Дизайн-система Local Arena iOS

Related documents: [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md) | [SPEC_MOBILE.md](SPEC_MOBILE.md)

## Принцип

Та же визуальная идентичность, нативные iOS-паттерны. Пользователь узнаёт Local Arena по палитре и типографике, но чувствует нативное iOS-приложение. Не порт WebView.
