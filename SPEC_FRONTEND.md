...
- Оверлей с backdrop
- Контент адаптируется по типу блока
- Внизу: теги (с возможностью добавить/удалить), дата, источник
- Кнопка закрытия (Esc или клик по backdrop)
- Стрелки для навигации к соседним блокам
