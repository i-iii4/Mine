...
### Проверка
Три новых теста: удаление копии при завершении; выборочность уборки на трёх
видах каталогов (завершённый, прерванный, завершённый с исчезнувшим файлом);
идемпотентность и устойчивость к отсутствующему каталогу. Полный Rust-набор —
676 тестов, clippy по изменённым файлам чист.
