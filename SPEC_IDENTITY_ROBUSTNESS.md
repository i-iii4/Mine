...
Статус: контракт согласован, доработка и проверки параллельной работы ещё не выполнены. Перед изменением роли реестра известные соответствия необходимо сохранить в совместимых ссылках без потери пользовательских правок.

## Текущая реализация, ещё не соответствующая целевому контракту

Источник привязок находится в `.mine/file-identity.json` внутри пространства.
