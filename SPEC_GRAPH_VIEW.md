...
пользователь: сначала мелкие миниатюры, потом рост в несколько заходов. При
смене состава снимка измерение сбрасывается, а первое измерение для новой
раскладки берётся на первом же медленном такте — как только форма узнаваема, —
и применяется **без сглаживания**. Дальнейшие уточнения ждут остановки движка,
иначе карточки меняли бы размер всё время, пока раскладка оседает.
