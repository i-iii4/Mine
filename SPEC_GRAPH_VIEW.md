...
**Размер идёт к новому значению анимацией, а не скачком.** Порог, принимавший
...
Сглаживание с постоянной времени `GRAPH_NODE_SIZE_TIME_CONSTANT_MS`
растворяет мелкий дрейф само и доводит настоящее изменение одним движением.
