...
Интерфейс для AI-агентов строится вокруг производных данных (гибридный поиск,
коллекции, резолв медиа), а не вокруг чтения файлов — Markdown агент читает и
без нас. Читающий API выносится в ядро; первым слоем — CLI `mine` (дёшево,
