...
### 041: Размер узла графа насыщается, а не следует за зумом бесконечно

Узел графа занимал ровно 32 экранных пикселя при любом масштабе: приближение
раздвигало связи, но не показывало содержимое крупнее. Целевое поведение —
размер растёт вместе с масштабом и упирается в потолок.
