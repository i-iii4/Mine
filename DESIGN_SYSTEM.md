...
Обязательный состав раздела:

- карточка ленты в ожидании содержимого, с меткой облака и без неё;
- развёрнутая карточка с превью и индикатором загрузки оригинала, с процентом;
...
- всплывающая карточка рекомендации в правом нижнем углу с галочкой
  `Don't show again`;
- карточка-дисклеймер в настройках, раздел `Spaces`;
- экран `Space unavailable` с тремя действиями;
- прогресс первичной индексации с числами;
