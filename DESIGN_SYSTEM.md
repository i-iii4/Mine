...
сфокусированный объект, который откроет Enter.
...
`Card actions` (`⌘K`) остаётся справочной по другой причине: меню открывается
там, где стоит карточка, и у нажатия в панели нет позиции, которую можно было
бы использовать. Запись появляется при открытой карточке и в ленте, когда есть
сфокусированная или выделенные. У
