...
**Правило:** сайдбар чуть темнее содержимого в обеих темах. Тёплый оттенок (hue ~78-106) — «бумажный» тон вместо стерильного серого. Sidebar.tsx использует `bg-sidebar`, не `bg-background`.
...
| Тёмная | oklch(0.3422 0.0069 286) | #38383C | 1px |
