...
Разделение общего ядра и нативного исполнителя реализовано в
[SPEC_SAVE_CORE.md](SPEC_SAVE_CORE.md): UniFFI напрямую использует чистые
правила `mine-core`, существующий storage остаётся нативным. UniFFI
остаётся тонким мостом: правила и общий сценарий не копируются в Swift или
FFI-обёртку. SC5 переносит существующие правила, не добавляя новые iOS-
