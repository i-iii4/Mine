...
| R3 | Идентичность | [SPEC_VAULT_LIFECYCLE.md](SPEC_VAULT_LIFECYCLE.md) П5–П11, П22 | Каноническая коллекция ближе к корню, распознавание перемещений, различение копии и переезда |
| R4 | Состояния пространства | [SPEC_VAULT_LIFECYCLE.md](SPEC_VAULT_LIFECYCLE.md) П12–П18, П23 | `Space unavailable`, удаление с кэшем, честная ошибка отсутствующего медиа |
| R5 | Облако | [SPEC_CLOUD_STORAGE.md](SPEC_CLOUD_STORAGE.md) | Неблокирующий интерфейс, честный прогресс, две иконки, встроенная рекомендация. Начинается с проверки Х23 на реально выгруженном файле |
| R6 | Клиппер | [SPEC_ONBOARDING.md](SPEC_ONBOARDING.md) О1–О8 | Публикация в Chrome Web Store, автономная запись на диск, установка связующего звена из приложения, yt-dlp в бандле |
| R7 | Первая сессия | [SPEC_ONBOARDING.md](SPEC_ONBOARDING.md) О9–О19 | Первый экран, подтверждение непустой папки, прогресс индексации, пустая лента, возврат импорта Are.na |
| R8 | Витрина | [DESIGN_SYSTEM.md](DESIGN_SYSTEM.md), раздел «Витрина состояний и краёв» | Все новые состояния отрисованы в разделе дизайн-системы. Условие приёмки всей фазы |
