...
| R5 | Облако | [SPEC_CLOUD_STORAGE.md](SPEC_CLOUD_STORAGE.md) | **DONE 15.08.2026** (кроме Х16–Х22, рекомендации). Определение выгруженного содержимого, запрет автовоспроизведения, превью-подложка в развороте, метка облака с задержкой, две иконки состояния |
