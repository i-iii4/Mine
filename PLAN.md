...
| V10 | Прогон `verify:release` при закрытом приложении | — | **DONE 17.08.2026.** Код возврата 0: биндинги, линтер, сборка, 878 фронтенд- и 708 Rust-тестов, пять браузерных аудитов, нативный smoke упакованного приложения (`ok: true` через tauri-ipc) |
