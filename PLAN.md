...
### Общее ядро сохранения — принято 31.08.2026, SC0 начат

Статус направления: **IN PROGRESS — SC0**. Контракт:
...
**Отмашка на реализацию получена.** Начат SC0: контракт и проверка безопасности
на одноразовых данных. SC1–SC7 ещё не начаты. Принятие направления не закрывает
...
|---|---|---|---|---|
| SC0. Контракт и безопасность | IN PROGRESS | Отмашка получена | Инвентарь владельцев правил и действующих API; конкретные типы запроса/результата; точки commit, повтор и журнал; эксперименты конкурентной записи и остановки на одноразовых папках | Зафиксированы границы native/browser, каждое окно сбоя и восстановления, правила совместимости; явно решён конфликт строгого no-clobber с ограничениями File System Access. Если нужны изменения пользовательской модели — отдельное согласование до продолжения |
