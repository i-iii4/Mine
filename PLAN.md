...
|---|---|---|---|
| R0 | Инструмент | [SPEC_VAULT_LIFECYCLE.md](SPEC_VAULT_LIFECYCLE.md) П23 | Приёмка холодного открытия сравнивает имена коллекций, а не пути; фикстура с папочной раскладкой. Делается первым: без честного инструмента остальное непроверяемо |
