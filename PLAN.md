...
| R1 | Данные | [SPEC_VAULT_LIFECYCLE.md](SPEC_VAULT_LIFECYCLE.md) П19–П21 | Уборка временных каталогов сохранения сразу после коммита плюс разовая чистка накопленного (113 каталогов, 109 МБ на рабочей машине) |
