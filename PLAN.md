...
[Согласованный контракт](</Users/i_iii/Проекты/Личные проекты/local-arena/docs/space-storage-requirements.md#совместимость-с-obsidian>): одна папка, одинаковые документы, вложения, свойства и связи в Mine и Obsidian. Полное выполнение пока не подтверждено.

- [ ] Свести запись и разрешение внутренних ссылок к общему правилу кратчайшего однозначного пути для приложения, нативного и автономного клиппера. Сохранить чтение старого синтаксиса, псевдонимы и якоря.
- [ ] Обеспечить уникальность новых имён во всём пространстве, сохраняя уже существующие одноимённые документы и вложения раздельно.
- [ ] Восстанавливать действующие связи из файлов без реестра; исправлять устаревшие Obsidian-пути только при единственной подходящей цели.
- [ ] Безопасно перенести известные соответствия текущего реестра в ссылки. Оставить реестр только для внешних переименований, без приоритета над пользовательскими изменениями.
- [ ] Защитить совместное редактирование от устаревших записей и циклов обновления. Проверить правки ссылок и свойств в Obsidian при работающем Mine.
- [ ] Добавить проверки удаления реестра до перемешивания файлов, удаления производных кэшей, сохранения клиппером при закрытом Mine и последующего открытия. Проверять исходные файлы и обе стороны связи.
- [ ] Проверить одну папку в обоих приложениях: чтение, редактирование, коллекции, вложения и переименование. Только после этого закрыть приёмку совместимости.
